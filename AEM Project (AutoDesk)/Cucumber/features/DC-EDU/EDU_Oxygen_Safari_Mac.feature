...
Feature: Education Download complete flow using different EDU account type on MAC Safari
  ...
  Scenario Outline: 2- As different user accounts, I'd like to be able to download releases with Stand-alone license.
    ...
    Examples:
      ...
      | students@mailinator.com | /qa-automation/education/free-software/autocad-edu-new  | Product Design Suite Ultimate 2009 | Mac OS X | English   | 901-00111259  | 766H1       | For use on personal device only | Browser Download |
