...
def get_firefox_with_cache_cleared():
    ...
    driver = \
        webdriver.Firefox(executable_path=r'/home/scarlet/Projects/PyEnvs/WebScrapingEnv/geckodriver'
...
def get_chrome_with_cache_cleared():
    ...
    driver = \
        webdriver.Chrome(executable_path='/home/scarlet/Projects/PyEnvs/WebScrapingEnv/chromedriver'
                         , chrome_options=chrome_options)  # Chrome Driver Path
...
def after_step(context, step):
    if take_screenshot:
        if step.status == 'failed':
            context.driver.save_screenshot(context.scenario.name + ' '
                    + step.name + '.png')
